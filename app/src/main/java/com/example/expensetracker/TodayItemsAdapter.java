...
public class TodayItemsAdapter  extends RecyclerView.Adapter<TodayItemsAdapter.ViewHolder> {
    ...
    private void updateData() {
        ...
        final EditText mNotes = mView.findViewById(R.id.notes);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference reference = FirebaseDatabase.getInstance().getReference("expenses").child(FirebaseAuth.getInstance().getUid());
