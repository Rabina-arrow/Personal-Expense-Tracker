...
public class TodayExpenseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        todayItemsAdapter = new TodayItemsAdapter(TodayExpenseActivity.this, myDataList);
                    ...
                    expensesRef.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(TodayExpenseActivity.this, "Budget item added successfully", Toast.LENGTH_SHORT).show();
                            } else {
